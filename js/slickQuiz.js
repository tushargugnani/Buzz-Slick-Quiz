        ...
        plugin.method = {
                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var answerContent = $('<li id="'+ optionId +'" class="'+inputName+'" image="'+answer.image+'"></li>')
									.append(optionName)
                                    .append(input)
									.append(checkboxDiv);
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<div id="buttonDiv"><a href="#" class="button ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a></div>');
                        } else {
                            questionHTML.append('<div id="buttonDiv"><a href="#" class="button ' + nextQuestionClass + '">' + nextText + '</a><div>');
                            questionHTML.append('<div id="buttonDiv"><a href="#" class="button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a></div>');
                        }
            ...
            nextQuestion: function(nextButton, options) {
				...
				for (var i = 0; i < 6; i++) {
					...
					$('li[id="'+questionId+'_'+i+'"]').css("background-size",'100% 100%');
				}
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableRanking) {
                    ...
                    /*var levels    = [
						...
						if (plugin.method.inRange(7,12, totalPointValue)) {
							levelRank = 5;
						} else if (plugin.method.inRange(13,18, totalPointValue)) {
							levelRank = 4;
						} else if (plugin.method.inRange(19, 24, totalPointValue)) {
							levelRank = 3;
						} else if (plugin.method.inRange(25, 30, totalPointValue)) {
							levelRank = 2;
						} else if (plugin.method.inRange(31, 35, totalPointValue)) {
							levelRank = 1;
						}
